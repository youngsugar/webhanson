        ...
        <div className="col-lg-9 order-lg-2 productlist" style={{ textAlign: 'justify' }}>
            <div className="row">
                <div className="col-lg-12" style={{ display: 'flex', justifyContent: 'center', alignContent: 'center', marginBottom: '20px' }}>
                    <img alt="challenge-coupling-hrc"src={process.env.PUBLIC_URL + '/Assets/img/Gallery/challenge-logo.png'} />
                </div>
            </div>
            <div className="col-lg-12 product-title">
                <h2>Taper Bored Coupling Half Body HRC</h2>
            </div>

            <div className="row">
                <div className="col-lg-5 order-lg-1 image-product-detail">
                    <img src={process.env.PUBLIC_URL + "/Assets/img/Gallery/coupling-hrc.png"} alt="coupling-ffx" />
                </div>
                <div className="col-lg-7 order-lg-2" >
                    ...
                    <div class="tab-content">
                        ...
                        <div className="brand-wrapper">
                            ...
                            <span><b>Available size</b> : 3020,2012</span>
                        </div>
...
export default itemCouplingHRC
